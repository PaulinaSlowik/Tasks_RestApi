...
public class TrelloClientTest {
    ...
    public void init() {
        ...
        when(trelloConfig.getTrelloAppUser()).thenReturn("/members/paulina06426045/boards");
    ...
    public void shouldFetchTrelloBoards() throws URISyntaxException {
        ...
        URI uri = new URI("http://test.com/members/paulina06426045/boards?key=test&token=test&fields=name,id&lists=all");
